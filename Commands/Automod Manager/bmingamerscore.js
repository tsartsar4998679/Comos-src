...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('bmingamerscore')
        .setDescription('Set a minimum gamerscore required for players to join the realm')
...
**__ Realms Updated __**
            `)
                                    ...
                                    const updatePromises = NonEmptySlots.slice(0, 5).map(async (Realm) => {
                                        ...
                                        if (configExists) {
                                            ...
                                            EmbedUpdate.addFields({
                                                ...
                                                value: `${end} Gamerscore: \`${amount}\``
                                            });
                                            ConfigUpdate.set("Gamerscore", amount);
                                            ConfigUpdate.save();
                                        } else {
                                            EmbedUpdate.addFields({
                                                name: `${denied} Realm Name: ${Realm.name}`,
                                                value: `${end} \`Could Not Update Gamerscore Amount\``
                                            });
                                        }
                                    });
                                    ...
                                    ConfigEditor.set("Gamerscore", amount);
                                    ConfigEditor.save();
