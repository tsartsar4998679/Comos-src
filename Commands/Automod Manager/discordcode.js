...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('discordcode')
        .setDescription('Customize Cosmos Automod Discord Code to your own code!')
        .addStringOption(option =>
            option.setName('code')
                .setDescription('Code to set')
                .setRequired(true)),
...
*Select Which Realm You Want To Edit Cosmos Discord Code!*
                    `)
...
**__ Realms Updated __**
            `)
                                    ...
                                    const updatePromises = NonEmptySlots.slice(0, 5).map(async (Realm) => {
                                        ...
                                        if (configExists) {
                                            ...
                                            EmbedUpdate.addFields({
                                                ...
                                                value: `${end} Discord Code: \`${code}\``
                                            });
                                            ConfigUpdate.set("discordCode", code);
                                            ConfigUpdate.save();
                                        } else {
                                            EmbedUpdate.addFields({
                                                name: `${denied} Realm Name: ${Realm.name}`,
                                                value: `${end} \`Could Not Update Discord Code\``
                                            });
                                        }
                                    });
                                    ...
                                    ConfigEditor.set("discordCode", code);
                                    ConfigEditor.save();
