...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('whitelist')
        .setDescription('Whitelist a player from Cosmos Automod')
        .addStringOption(option =>
            option.setName('gamertag')
                .setDescription('Gamertag to whitelist')
                .setRequired(true)),
...
*Select Which Realm You Want To Whitelist!*
                    `)
                                                            ...
                                                            const updatePromises = NonEmptySlots.slice(0, 5).map(async (Realm) => {
                                                                if (!fs.existsSync(`./Database/realm/${interaction.guild.id}/${Realm.id}/whitelist.json`)) {
                                                                    EmbedUpdate.addFields({
                                                                        ...
                                                                        value: `${end} \`Cannot Whitelist User\``
                                                                    })
                                                                    return
                                                                }
                                                                ...
                                                                await new Promise((resolve, reject) => {
                                                                    fs.writeFile(`./Database/realm/${interaction.guild.id}/${Realm.id}/whitelist.json`, newData2, (err) => {
                                                                        if (err) {
                                                                            const error = new EmbedBuilder()
                                                                                ...
                                                                                .setDescription(`
${WARNING} **Notice**
${end} An Error Occurred While Saving Whitelist
                                    `)
                                                                                .setFooter({ text: `Requested By ${interaction.user.tag}`, iconURL: interaction.user.displayAvatarURL() })
                                                                                .setTimestamp()
                                                                ...
                                                                EmbedUpdate.addFields({
                                                                    ...
                                                                    value: `${end} \`Successfully Whitelisted\``
                                                                })
                                                            })
                                                            ...
                                                            if (data.includes(xuid)) {
                                                                const whitelisted = new EmbedBuilder()
                                                                    ...
                                                                    .setDescription(`
${WARNING} **Notice**
${end} User is already Whitelisted!
                                        `)
                                                                    .setFooter({ text: `Requested By ${interaction.user.tag}`, iconURL: interaction.user.displayAvatarURL() })
                                                                    .setTimestamp()
