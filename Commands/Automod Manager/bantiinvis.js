...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('bantiinvis')
        .setDescription('Change wheither use Cosmos Anti Invis Skins or not')
        .addBooleanOption(option =>
            option.setName('type')
                .setDescription('Activate or Deactivate Cosmos Anti-Invis')
                .setRequired(true)),
...
*Select Which Realm You Want To Enable/Disable Cosmos Anti-Invis Skins!*
                `)
...
**__ Realms Updated __**
            `)
                                    ...
                                    const updatePromises = NonEmptySlots.slice(0, 5).map(async (Realm) => {
                                        ...
                                        if (configExists) {
                                            ...
                                            EmbedUpdate.addFields({
                                                ...
                                                value: `${end} Anti-Invis: \`${type}\``
                                            });
                                            ConfigUpdate.set("antiinvis", type);
                                            ConfigUpdate.save();
                                        } else {
                                            EmbedUpdate.addFields({
                                                name: `${denied} Realm Name: ${Realm.name}`,
                                                value: `${end} \`Could Not Update Anti-Invis\``
                                            });
                                        }
                                    });
                                    ...
                                    ConfigEditor.set("antiinvis", type);
                                    ConfigEditor.save();
